...
public class serDoUpdateStu extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			int rs = update.updateStuPsd(stu);
			if(rs!=0){
				out.println("updatestupsd success!"+stu.getSNo());
			}else{
				out.println("updatestupsd error!"+stu.getSNo());
			}
			response.sendRedirect("/WebContent/tea/selectStu.jsp");
