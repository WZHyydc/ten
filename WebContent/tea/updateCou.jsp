	...
	<div class="main_right">
		...
		<div class="box">
			...
			<div class="form_1">
				...
				Course cou = selectone.selectCou(request.getParameter("cid"), request.getParameter("lid"));
				if(cou!=null){
				 %>
				...
				<table>
					...
					<tr><td>教学班编号</td> <td><input  class="text" type="text" name="Lessonno" value="<%= cou.getLessonNo() %>"/></td></tr>
					<tr><td>开课时间</td> <td><input  class="text" type="text" name="Classtime" value="<%= cou.getCtime() %>"/></td></tr>
					<tr><td>开课地点</td> <td><input  class="text" type="text" name="Classroom" value="<%= cou.getClassroom() %>"/></td></tr>
					<tr><td>授课老师</td> <td><input  class="text" type="text" name="Cteacher" value="<%= cou.getCteacher() %>"/></td></tr>
					<tr><td>教师职称</td> <td><input  class="text" type="text" name="Title" value="<%= cou.getTitle() %>"/></td></tr>
					<tr><td>开课班级最大人数</td> <td><input  class="text" type="text" name="Maxnum" value="<%= cou.getMaxnum() %>"/></td></tr>
